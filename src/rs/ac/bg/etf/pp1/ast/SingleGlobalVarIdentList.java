...
public class SingleGlobalVarIdentList extends GlobalVarIdentList {

    private VarIdent VarIdent;

    public SingleGlobalVarIdentList (VarIdent VarIdent) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("SingleGlobalVarIdentList(\n");
